    ...
    public partial class IntialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FoodDrinkId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderedItems", x => new { x.TicketId, x.FoodDrinkId });
                    table.ForeignKey(
                        name: "FK_OrderedItems_FoodDrinks_FoodDrinkId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderedItems_FoodDrinkId",
                table: "OrderedItems",
                column: "FoodDrinkId");
